...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/estilo-cozinha.css"/>
    <link rel="shortcut icon" href="../assets/img/logo-icone.png"
      type="image/x-icon"/>
      <script src="https://js.pusher.com/7.0/pusher.min.js"></script>

    <title>Interface em construção</title>

    
    <link rel="stylesheet" href="/cozinha/style_cozinha.css">
    <link
      rel="shortcut icon"
